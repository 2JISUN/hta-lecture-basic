...
!(function (t, e) {
    ...
    return (
      ...
      function (t, e, r) {
        ...
        if (!d) {
          ...
          for (
            d = y[c] = [], i = T ? Math.min(f, c) * w - 0.5 : m % f, n = f === U ? 0 : T ? (c * x) / f - 0.5 : (m / f) | 0, l = U, u = h = 0;
            u < c;
            u++
          )
            (a = (u % f) - i),
          ...
          "random" === m && db(d),
            ...
            (d.min = l),
            (d.v = c =
              (parseFloat(p.amount) || parseFloat(p.each) * (c < f ? c - 1 : b ? ("y" === b ? c / f : f) : Math.max(f, c / f)) || 0) *
              ("edges" === m ? -1 : 1)),
            (d.b = c < 0 ? g - c : g),
  ...
  var B,
    ...
    At = function _callback(t, e, r) {
      ...
      if (o)
        return (
          (i = s[e + "Params"]), (n = s.callbackScope || t), r && ct.length && ma(), h && (l = h), (a = i ? o.apply(n, i) : o.call(n)), (l = u), a
        );
    },
    Ct = [],
    St = 255,
  ...
  var Nt,
    ...
    Qt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
      ...
      var c,
        ...
        _ = s(d) ? (l ? re : te) : $t;
      if (
        (r(n) && (~n.indexOf("random(") && (n = ob(n)), "=" === n.charAt(1) && ((!(c = ka(p, n) + (Ya(p) || 0)) && 0 !== c) || (n = c))),
        !f || p !== n || Wt)
      )
        return isNaN(p * n) || "" === n
          ? (d || e in t || Q(e, n),
          ...
          if (m !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != _)) {
            if (((i = m), (l = this.timeline), this._repeat)) {
              ...
              a !== o &&
                ...
                !this.vars.repeatRefresh || u || this._lock || ((this._lock = r = 1), (this.render(ja(s * a), !0).invalidate()._lock = 0)));
            }
            if (!this._initted) {
            ...
            (l && l.render(t < 0 ? t : !i && u ? -X : l._dur * l._ease(i / this._dur), e, r)) || (this._startAt && (this._zTime = t)),
              ...
              (m !== this._tDur && m) ||
                ...
                e ||
                  (_ && !c) ||
                  !(m || c || u) ||
                  (At(this, m === d ? "onComplete" : "onReverseComplete", !0), !this._prom || (m < d && 0 < this.timeScale()) || this._prom()));
          }
        } else
          !(function _renderZeroDurationTween(t, e, r, i) {
            ...
            if (
              ...
              e < 0 && Ca(t, e, 0, !0),
                ...
                (e >= t._tDur || e < 0) &&
                  t.ratio === u &&
                  (u && za(t, 1), r || L || (At(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
  ...
  function Xd(t, e) {
    if (e) {
      ...
      e in ar && e !== pr && (e = dr),
        r.removeProperty
          ? (("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6)) || (e = "-" + e), r.removeProperty(e.replace(hr, "-$1").toLowerCase()))
          : r.removeAttribute(e);
    }
  }
  ...
  var De,
        ...
        m !== wr &&
          ...
          6 === m.length
            ...
            : ((R = m[6]),
              ...
              (l = (g = ur(-w, E)) * sr),
              g &&
                ((v = Math.cos(-g)), (z = x * (y = Math.sin(-g)) + z * v), (T = O = T * v - C * y), (b = P = b * v - S * y), (w = A = w * v - E * y)),
              (u = (g = ur(b, T)) * sr),
              g &&
    ...
    Sr = function _renderCSSTransforms(t, e) {
      ...
      _ !== Ar && (y += "perspective(" + _ + Cr),
        (i || n) && (y += "translate(" + i + "%, " + n + "%) "),
        (!T && a === Ar && s === Ar && o === Ar) ||
          (y += o !== Ar || T ? "translate3d(" + a + ", " + s + ", " + o + ") " : "translate(" + a + ", " + s + Cr),
        u !== Pr && (y += "rotate(" + u + Cr),
        h !== Pr && (y += "rotateY(" + h + Cr),
        l !== Pr && (y += "rotateX(" + l + Cr),
